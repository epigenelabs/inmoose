...
class Test(unittest.TestCase):
    ...
    def test_lmFit_with_missing_values(self):
        ...
        df_residual_ref = [2.0, 4.0, 3.0, 4.0, 4.0, 3.0, 4.0, 4.0, 4.0, 4.0]
        ...
        cov_ref = pd.DataFrame(
            {0: [0.3333333333333333, 0.0], 1: [0.0, 0.3333333333333333]},
            index=[0, 1],
        )
        pd.testing.assert_frame_equal(
            pd.DataFrame(fit.cov_coefficients), cov_ref, rtol=1e-6
        )
